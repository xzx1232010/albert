...
def main(_):
    ...
    model_fn = model_fn_builder(
        ...
        use_one_hot_embeddings=FLAGS.use_tpu)  # use_one_hot_embeddings为False，单纯是速度的原因，再tpu用one_hot会快很多
    ...
    estimator = tf.contrib.tpu.TPUEstimator(
        use_tpu=FLAGS.use_tpu,
        model_fn=model_fn,
        config=run_config,  # 此参数对gpu来说没用，run_config单纯为TPU配置使用的
